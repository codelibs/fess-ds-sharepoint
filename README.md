SharePoint Data Store for Fess [![Build Status](https://travis-ci.org/codelibs/fess-ds-sharepoint.svg?branch=master)](https://travis-ci.org/codelibs/fess-ds-sharepoint)
==========================
